...
```
 ...
 Development 과정 중 cortex에서는 neuroephithelial progenitor cell이 radial gila cell로 발달하며 neuron과 astrocyte가 나타나게 된다. 이 과정은 gene expression 양상의 변화가 필연적이다. 따라서 neuron이 나타나는 neurogensis를 onset, progrss, terminate하는 것으로 알려진 7개 유전자의 expression 양상 또한 달라질 것으로 예상하였다. 분석 전 예상은 expression graph의 peak가 3개의 집단으로 나뉘어지는 것이었다. 즉 onset gene들이 동시에 peak를 보이고, progression, termination gene이 각각 peak를 보이는 것이었다. 실제로 expression 양상은 예상과 동일하게 onset gene이 최고점을 찍은 후 progression gene과 Termination gene의 최고점이 그 뒤를 잇는 형태였다. 단 이것이 명확하게 peak로 나타나지는 않았으며, onset gene이 감소하면서 progression gene은 고농도를 유지하는 구간이 불명확하고 짧게 나타났다. 또한 그 부분 외의 다양한 지점에서 극대값이 나타나고 있다. 거기다가 예상했던 양상이 나오는 구간이 실제로 인간 배아에서 neurogenesis가 일어나는 구간인지 명확하지 않다.
